...
import com.roastos.app.RoastAiResponses
...
object AiRoastAssistantPage {
    ...
    fun show(context: Context, container: LinearLayout) {
        ...
        root.addView(
            UiKit.pageSubtitle(
                context,
                "Realtime roast interpretation, local AI reasoning, and action guidance."
            )
        )
        ...
        val promptInput = textInput(context, "Ask AI", "What should I do now?")
        ...
        fun currentMachineState() = MachineStateEngine.buildState(
            ...
            elapsedSec = MachineTelemetryEngine.currentState().liveElapsedSec
                .takeIf { it > 0 }
                ?: elapsedInput.text.toString().toIntOrNull()
                ?: 0,
...
${styleGoal.styleName}
        ...
        askAiBtn.setOnClickListener {
            ...
            val localAiResponse = RoastAiResponses.textExplanation(
                text = """
Local Roast AI Analysis

Prompt
${promptInput.text.toString().ifBlank { "No prompt" }}

Brain Summary
${brain.aiSummary}

Operator Summary
${brain.operatorSummary}

Recommendation
Use the AI decision below as the next action reference.
                """.trimIndent(),
                reasoning = "Generated locally from RoastAiBrain without remote service call."
            )
            ...
            latestAiResponseText = localAiResponse.summary()
